...
class sj_users(models.Model):
    ...
    admin_state = models.CharField(max_length=20, default='', blank=True, null=True)
...
class sj_events(models.Model):
    ...
    event_location = models.CharField(verbose_name="Ort", max_length=100, blank=True, default='')
